...
docker pull ghcr.io/0to1toeverything/new-api:latest
...
docker run --name new-api -d --restart always \
  ...
  -e TZ=Asia/Shanghai \
  -v ./data:/data \
  ghcr.io/0to1toeverything/new-api:latest
...
> [!TIP]
> **Dernière image Docker:** `ghcr.io/0to1toeverything/new-api:latest`
